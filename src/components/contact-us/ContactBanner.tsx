          ...
          <div className="text-white">
            <RevealAnimation delay={0.1} direction="up">
              <div className="mb-6 inline-block">
                <span className="text-sm font-bold tracking-widest text-[#d4af37] uppercase">Contact Us</span>
            ...
            <RevealAnimation delay={0.3} direction="up">
              <p className="mb-10 max-w-xl text-lg leading-relaxed text-white/80 md:text-xl">
                Have a question about membership, events, or donations? Need assistance with your alumni account? Our
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
              <RevealAnimation delay={0.4} direction="up">
                <div className="group flex flex-col gap-3">
                  <div className="flex size-10 items-center justify-center rounded-lg bg-white/10 transition-all duration-500 group-hover:scale-110 group-hover:shadow-lg">
                    <svg
                  ...
                  <span className="text-sm font-bold tracking-wide">Quick Response</span>
                </div>
              </RevealAnimation>
              <RevealAnimation delay={0.5} direction="up">
                <div className="group flex flex-col gap-3">
                  ...
                  <span className="text-sm font-bold tracking-wide">Trusted Support</span>
                </div>
              </RevealAnimation>
              <RevealAnimation delay={0.6} direction="up">
                <div className="group flex flex-col gap-3">
                  ...
                  <span className="text-sm font-bold tracking-wide">Alumni Focused</span>
                </div>
              </RevealAnimation>
            </div>
          </div>
          {/* RHS is now just empty for layout, image is background */}
