...
const AboutCTA = () => {
  return (
    <section className="py-10 md:py-14" aria-label="cta section wrapper">
      <div className="main-container">
        <RevealAnimation delay={0.1}>
          <div className="bg-secondary dark:bg-background-8 relative overflow-hidden rounded-[20px]">
            ...
            <CTA
              ...
              description="Join the FGCEOSA community today and contribute to the legacy of excellence and unity."
              headingClass="text-white"
              descriptionClass="text-white/70"
              ctaHeading="Ready to reconnect with your alumni network?"
              ctaBtnText="Join FGCEOSA"
              badgeText="Get Started"
              badgeClass="badge badge-blur text-accent"
