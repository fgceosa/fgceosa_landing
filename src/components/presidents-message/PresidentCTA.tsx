...
const PresidentCTA = () => {
  const coreValues = [
    ...
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
          <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6.223a9.904 9.904 0 0 0 3.84 8.784 12.042 12.042 0 0 0 4.562 2.624 12.042 12.042 0 0 0 4.562-2.624 9.904 9.904 0 0 0 3.84-8.784A11.959 11.959 0 0 1 12 2.714Z" />
        </svg>
      ),
      title: 'Integrity',
  ...
  return (
    <section className="bg-background-3 dark:bg-background-8">
      {/* Core Values Section */}
      <div className="py-12 md:py-16 border-b border-gray-100 dark:border-white/5 bg-white dark:bg-background-7">
        <div className="main-container">
          <div className="text-center mb-12">
            <RevealAnimation delay={0.2}>
              <h2 className="text-secondary dark:text-accent font-bold text-3xl md:text-4xl mt-3">Guided by Our Core Values</h2>
            </RevealAnimation>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 md:gap-8">
            {coreValues.map((value, index) => (
              <RevealAnimation key={index} delay={0.1 * (index + 1)} direction="up">
                <div className="bg-background-3 dark:bg-background-6 p-6 md:p-8 rounded-3xl border border-gray-100 dark:border-stroke-7 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-500 h-full group">
                  <div className="size-14 rounded-2xl bg-secondary flex items-center justify-center mb-6 text-white group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-secondary/20 transition-all duration-500">
                    {value.icon}
                  </div>
                  <h4 className="font-bold text-lg md:text-xl mb-3 text-secondary dark:text-accent">{value.title}</h4>
      ...
      <div className="py-12 md:py-16">
        <div className="main-container">
          <div className="bg-secondary rounded-[32px] p-8 md:p-16 border border-white/5 shadow-2xl overflow-hidden relative">
            {/* Background Accent */}
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center gap-10">
              <RevealAnimation delay={0.1} direction="left">
                <div className="size-20 md:size-24 bg-white/10 rounded-3xl flex items-center justify-center text-white shrink-0 shadow-inner">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-10 md:size-12">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.332A48.36 48.36 0 0 0 12 9.75c-2.551 0-5.056.2-7.5.582V21M3 21h18M12 6.75h.008v.008H12V6.75Z" />
                  </svg>
                </div>
              </RevealAnimation>
              ...
              <div className="flex-1 text-center lg:text-left">
                <RevealAnimation delay={0.2} direction="up">
                  <div>
                    <h5 className="font-black mb-4 text-white leading-tight">
                      Today We Build A Legacy That Lives On.
                    </h5>
                    <p className="text-white/80 text-base md:text-lg max-w-2xl">
                      Join us in our mission to transform our alma mater and create lasting impact for generations of students yet to come. Your support makes the difference.
                    </p>
                  </div>
                </RevealAnimation>
              </div>
      ...
      <div className="py-8 border-t border-gray-100 dark:border-white/5">
        <div className="main-container">
          <RevealAnimation delay={0.1} direction="up">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-10 px-4 md:px-10 pb-8">
              <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8 text-center md:text-left">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-base md:text-lg text-black dark:text-gray-200 font-medium italic max-w-xl">
