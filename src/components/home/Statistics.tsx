    ...
    <section className="bg-background-2 dark:bg-background-5 relative overflow-hidden py-10">
      ...
      <RevealAnimation delay={0.1}>
        <div className="relative">
          <div className="dark:from-background-5 from-background-2 absolute top-0 left-0 z-40 h-full w-[15%] bg-gradient-to-r to-transparent md:w-[20%]" />
          <div className="dark:from-background-5 from-background-2 absolute top-0 right-0 z-40 h-full w-[15%] bg-gradient-to-l to-transparent md:w-[20%]" />
            ...
            <div className="mb-14 flex items-center justify-center max-md:gap-x-8 max-md:gap-y-[42px] md:gap-8">
              {data.map((item, index) => (
                <div
                  key={item.id}
                  className={cn(
                    'hover:bg-secondary border-stroke-4 dark:border-stroke-6 group relative z-0 flex min-h-[200px] w-full min-w-[280px] flex-col justify-between gap-y-6 overflow-hidden rounded-[20px] border p-6 transition-all duration-500 ease-in-out',
                    index === 0 && 'ml-8',
                  )}>
                  <div className="flex items-center justify-between">
                    <div className="bg-secondary/10 text-secondary group-hover:text-secondary rounded-xl p-3 transition-colors duration-500 group-hover:bg-white">
                      {item.icon}
                    </div>
                  </div>
