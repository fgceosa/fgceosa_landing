          ...
          <div className="lg:col-span-5 space-y-8 md:space-y-10 text-center lg:text-left order-1">
            <div className="space-y-6">
              ...
              <RevealAnimation delay={0.2}>
                <h2 className="text-secondary font-bold text-3xl md:text-4xl lg:text-5xl lg:text-[52px] leading-[1.1] tracking-tight">
                  Capturing Decades of <br className="hidden md:block" />
                  <span className="text-secondary/40 italic font-serif">Excellence & Memories.</span>
                </h2>
              </RevealAnimation>

              <RevealAnimation delay={0.3}>
                <p className="text-black/60 text-base md:text-lg max-w-[450px] mx-auto lg:mx-0 font-medium leading-relaxed">
                  Explore the visual history of FGCEOSA. From nostalgic reunions to impactful community projects, every frame tells a story of unity and growth.
                </p>
              </RevealAnimation>
            </div>
            ...
            <RevealAnimation delay={0.4}>
              <div className="flex flex-col sm:flex-row items-center gap-6 justify-center lg:justify-start">
                ...
                <Link href="#" className="text-secondary font-bold text-base hover:underline underline-offset-8 decoration-2 decoration-secondary/30 transition-all">
                  Submit a Memory
                </Link>
              </div>
            </RevealAnimation>
